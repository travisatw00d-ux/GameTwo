...
public class HumanoidRig {
    ...
    public static final String CLAVICLE_L = "Clavicle.L";
    public static final String CLAVICLE_R = "Clavicle.R";
    public static final String UPPER_ARM_L = "Upper_Arm.L";
    public static final String FORE_ARM_L = "ForeArm.L";
    public static final String LOWER_ARM_L = "Lower_Arm.L";
    ...
    public static final String LOWER_ARM_R = "Lower_Arm.R";
    ...
    public static final String[] ALL_BONES = {
        ...
        UPPER_ARM_L, FORE_ARM_L, LOWER_ARM_L, HAND_L,
        UPPER_ARM_R, FORE_ARM_R, LOWER_ARM_R, HAND_R,
        LEG_L, SHIN_L, FOOT_L,
        LEG_R, SHIN_R, FOOT_R
    };
    ...
    public Joint getClavicleL()   { return joints.get(CLAVICLE_L); }
    public Joint getClavicleR()   { return joints.get(CLAVICLE_R); }
    public Joint getUpperArmL()   { return joints.get(UPPER_ARM_L); }
    public Joint getForeArmL()    { return joints.get(FORE_ARM_L); }
    public Joint getLowerArmL()   { return joints.get(LOWER_ARM_L); }
    ...
    public Joint getLowerArmR()   { return joints.get(LOWER_ARM_R); }
